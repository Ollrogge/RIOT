 ...
 */
static inline unsigned _periph_numof_is_unsigned_0(void) { return 0; }

static const uart_conf_t uart_config[] = {{.dev = UART0,
                                           .rx_pin = GPIO_PIN(0, 1),
                                           .tx_pin = GPIO_PIN(0, 0),
                                           .irqn = UART0_IRQ_IRQn},
                                          {.dev = UART1,
...
static const spi_conf_t spi_config[] = {{.dev = SPI0,
...
static const pio_conf_t pio_config[] = {
    {.dev = PIO0, .irqn0 = PIO0_IRQ_0_IRQn, .irqn1 = PIO0_IRQ_1_IRQn},
    {.dev = PIO1, .irqn0 = PIO1_IRQ_0_IRQn, .irqn1 = PIO1_IRQ_1_IRQn}};
 ...
 */
static const pio_i2c_conf_t pio_i2c_config[] = {PIO_I2C_CONFIG};
/**
